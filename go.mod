...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/health v1.40.2
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/kafkaexporter v0.156.0
...
require (
	...
	go.opentelemetry.io/collector/extension/xextension v0.157.0
